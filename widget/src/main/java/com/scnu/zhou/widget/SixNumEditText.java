...
public class SixNumEditText extends LinearLayout {
    ...
    private int textColor = Color.parseColor("#97CC00");
    ...
    public SixNumEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SixNumEditText);
        textColor = a.getColor(R.styleable.SixNumEditText_textColor, Color.parseColor("#97CC00"));
    ...
    private void init(){
        ...
        num01.setTextColor(textColor);
        num02.setTextColor(textColor);
        num03.setTextColor(textColor);
        num04.setTextColor(textColor);
        num05.setTextColor(textColor);
        num06.setTextColor(textColor);
    }
